...
import fondoBg from '../../assets/cafam/fondo-cafam.svg';
import video1 from '../../assets/cafam/parrilla-1.mp4';
import video2 from '../../assets/cafam/parrilla-2.mp4';
import video3 from '../../assets/cafam/parrilla-3.mp4';

const posts = [
  { id: 1, title: "Parrilla 1", videoSrc: video1, link: "https://www.instagram.com/p/C7h5egHJhus/" },
  { id: 2, title: "Parrilla 2", videoSrc: video2, link: "https://www.instagram.com/p/C6_ZUOZgW3k/" },
  { id: 3, title: "Parrilla 3", videoSrc: video3, link: "https://www.instagram.com/p/C878VVypieu/" }
];
  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        className="mt-2 flex items-center justify-center gap-2 w-full max-w-[280px] border-4 border-[#111] bg-white text-[#111] px-4 py-3 font-black shadow-[4px_4px_0px_0px_rgba(17,17,17,1)] transition-all uppercase tracking-widest text-sm hover:bg-[#FF307A]"
      >
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto p-6 md:p-12 min-h-full flex flex-col">
        ...
        <motion.div 
          ...
          className="mb-16 text-center w-full mt-4"
        >
          <div className="inline-block bg-[#FF307A] border-4 border-[#111] px-6 py-2 shadow-[6px_6px_0px_0px_rgba(17,17,17,1)] -rotate-2">
          ...
          <p className="mt-6 text-xl md:text-2xl font-bold max-w-2xl mx-auto bg-white border-4 border-[#111] p-4 shadow-[4px_4px_0px_0px_rgba(17,17,17,1)]">
            Contenido de valor, cercano y siempre enfocado en el bienestar de la comunidad. 💊
          </p>
        </motion.div>
        ...
        <div className="mt-8 text-center pb-8">
          <motion.a 
            ...
            href="https://www.instagram.com/drogueriascafam/"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            Droguerías Cafam <ExternalLink size={18} />
          </motion.a>
        </div>
